    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-[24px] shadow-[0_25px_50px_rgba(0,0,0,0.15)] max-w-lg w-full overflow-hidden border border-[#E2E8F0]">
        ...
        <div className="p-6 space-y-4">
          ...
          {unanswered.length > 0 && (
            <div>
              <p className="text-sm font-semibold text-[#1B2B4B] mb-2">⚠️ Unanswered Questions</p>
          ...
          <div className="bg-[#dc3545]/10 border border-[#dc3545]/20 rounded-xl p-4">
            <p className="text-sm text-[#dc3545] font-medium">⚠️ Once submitted, you cannot change your answers.</p>
          </div>
